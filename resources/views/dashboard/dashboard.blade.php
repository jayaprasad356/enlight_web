...
@section('content')
    <div class="row">
        ...
        <div class="col-12 mb-3">
            ...
            <h5>{{ __('One Time Membership Charges - ₹499') }}</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto text-end">
                                    <h4 class="m-0 text-secondary">{{ number_format($payment_wallet, 2) }}</h4>
                                </div>
                            </div>
                            <div class="text-center mt-3">
                            <a href="javascript:void(0);" class="btn btn-secondary" onclick="addToBalance('whatsapp_status_income', {{ $whatsapp_status_income }})">
                                    {{ __('Add to Withdrawals') }}
                                </a>
...
function copyShareLink() {
    var referCode = "{{ session('refer_code') }}"; // Correct way to retrieve session variable
    ...
    var link = "{{ route('addusers') }}" + "?refer_code=" + referCode; // Append referral code to URL
