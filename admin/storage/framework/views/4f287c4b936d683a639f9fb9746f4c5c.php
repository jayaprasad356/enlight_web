                ...
                <form action="<?php echo e(route('withdrawals.index')); ?>" method="GET" class="mb-3">
                    <div class="d-flex flex-wrap align-items-end gap-3">
                        ...
                        <div class="ms-auto d-flex gap-2">
                          <a href="<?php echo e(route('withdrawals.export', ['status' => request()->get('status', ''), 'filter_date' => request()->get('filter_date', '')])); ?>" class="btn btn-primary">
                                <?php echo e(__('Export Withdrawals')); ?>

                            </a>
                            <a href="<?php echo e(route('withdrawals.unpaid_export', ['status' => request()->get('status', 0), 'filter_date' => request()->get('filter_date')])); ?>" class="btn btn-primary">
                                <?php echo e(__('Export Unpaid Withdrawals')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\enlight_web\admin\resources\views/withdrawals/index.blade.php ENDPATH**/ ?>