...
<?php $__env->startSection('content'); ?>
    <div class="card-body">
        ...
        <!-- Login Title -->
        <div>
           <center><h2 class="mb-3 f-w-600"><?php echo e(__('Jiyo - Login page')); ?></h2></center> 
        </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_new\resources\views/auth/login.blade.php ENDPATH**/ ?>