...
<?php $__env->startSection('title', 'Enlight Lending'); ?>
<?php $__env->startSection('content-header', 'Enlight Lending'); ?>
...
<div class="container mt-5">
    ...
    <div class="row mb-4 text-center">
        <div class="col-md-4">
            <img src="<?php echo e(asset('storage/earnings/earnings_1.jpeg')); ?>" alt="Image 1" class="img-fluid rounded shadow">
        </div>
        <div class="col-md-4">
            <img src="<?php echo e(asset('storage/earnings/earnings_2.jpeg')); ?>" alt="Image 2" class="img-fluid rounded shadow">
        </div>
        <div class="col-md-4">
            <img src="<?php echo e(asset('storage/earnings/earnings_3.jpeg')); ?>" alt="Image 3" class="img-fluid rounded shadow">
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\enlight_web\resources\views/enlight_lending/index.blade.php ENDPATH**/ ?>