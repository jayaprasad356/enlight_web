    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5><?php echo e(__('Payment Screenshot List')); ?></h5>
            </div>
                            ...
                            <?php $__currentLoopData = $payment_screenshots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment_screenshot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                   <td><?php echo e(ucfirst($payment_screenshot->id)); ?></td>
                                    <td>
                                        <a href="<?php echo e(asset('storage/app/public/' . $payment_screenshot->screenshots)); ?>" data-lightbox="image-<?php echo e($payment_screenshot->id); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\enlight_web\resources\views/payment_screenshots/index.blade.php ENDPATH**/ ?>