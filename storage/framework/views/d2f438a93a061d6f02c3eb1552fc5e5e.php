...
<div class="container mt-5">
    ...
    <div class="row text-center">
        <div class="col-md-8 offset-md-2">
            ...
            <a href="<?php echo e(route('mobile.login')); ?>" class="btn btn-lg btn-primary mt-3">Join Now</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\enlight_web\resources\views/about-us.blade.php ENDPATH**/ ?>